...
export default function Dashboard() {
  ...
  const { getRemaining, getCompleted } = useShopping()
  ...
  return (
    <div className="dashboard scroll">
      ...
      <div className="stat-grid">
        {LISTS.map(list => {
          const open = list.key === 'shop' ? getRemaining() : countOpen(list.api)
          const done = list.key === 'shop' ? getCompleted() : countDone(list.api)
